...
- **Study area** — distraction-free focus mode with a built-in timer
- **Cross-platform** — runs on both Windows and macOS via Electron

## Tech

- **Electron** — cross-platform desktop shell
- **React** — component-based UI
- **TypeScript** — typed JavaScript for a more maintainable codebase
- **Node.js** — backend logic and file system access
